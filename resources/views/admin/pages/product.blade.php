...
@section('product-nav', 'active open')
...
@section('js')
    ...
    <div class="modal fade" id="addProduct" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="title" id="addProductLabel">Add Project</h4>
                </div>
                <div class="modal-body">
                    <form id="addProduct">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="gambar[]">Gambar</label>
                            <button class="btn btn-primary btn-sm" id="addGambar" type="button"><i class="zmdi zmdi-plus"></i></button>
                            <button class="btn btn-secondary btn-sm" id="removeGambar" type="button"><i class="zmdi zmdi-minus"></i></button>
                            <div id="gambarGroup">
                                <input type="file" name="gambar[]" id="gambar[]" accept="image/*" required class="form-control gambar">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
