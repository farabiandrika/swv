      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <div class="single-banner-image">
            <a href="shop.html">
              <img class="w-100" src="{{ asset('customer/assets/img/shop/banner/3.jpg') }}" alt="Image-HasTech">
            </a>
          </div>
        ...
        <div class="col-sm-6">
          ...
          <div class="single-banner-image">
            <a href="shop.html">
              <img class="w-100" src="{{ asset('customer/assets/img/shop/banner/4.jpg') }}" alt="Image-HasTech">
            </a>
          </div>
          <!--== End Single Banner Item ==-->
        </div>
                  ...
                  <div class="inner-content">
                    <div class="thumb">
                      <a href="single-blog.html">
                        <img class="w-100" src="{{ asset('customer/assets/img/blog/1.jpg') }}" alt="Image-HasTech">
                      </a>
                    </div>
                    <div class="content">
                      <ul class="meta">
              ...
              <div class="swiper-slide">
                ...
                <div class="post-item">
                  <div class="inner-content">
                    <div class="thumb">
                      <a href="single-blog.html">
                        <img class="w-100" src="{{ asset('customer/assets/img/blog/2.jpg') }}" alt="Image-HasTech">
                      </a>
                    </div>
                    <div class="content">
                      <ul class="meta">
                        <li><span>post by: </span><a class="author" href="blog.html">Morem</a></li>
                        <li><span> - Jan, 24 , 22</span></li>
                      </ul>
              ...
              <div class="swiper-slide">
                ...
                <div class="post-item">
                  <div class="inner-content">
                    <div class="thumb">
                      <a href="single-blog.html">
                        <img class="w-100" src="{{ asset('customer/assets/img/blog/3.jpg') }}" alt="Image-HasTech">
                      </a>
                    </div>
                    <div class="content">
                      <ul class="meta">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  <div class="brand-logo-item">
                    <a href="shop.html"><img src="{{ asset('customer/assets/img/brand-logo/1.jpg') }}" alt="Image-HasTech"></a>
                  </div>
                  <!--== End Brand Logo Item ==-->
                </div>
                <div class="swiper-slide">
                  <!--== Start Brand Logo Item ==-->
                  <div class="brand-logo-item">
                    <a href="shop.html"><img src="{{ asset('customer/assets/img/brand-logo/2.jpg') }}" alt="Image-HasTech"></a>
                  </div>
                  <!--== End Brand Logo Item ==-->
                </div>
                <div class="swiper-slide">
                  <!--== Start Brand Logo Item ==-->
                  <div class="brand-logo-item">
                    <a href="shop.html"><img src="{{ asset('customer/assets/img/brand-logo/3.jpg') }}" alt="Image-HasTech"></a>
                  </div>
                  <!--== End Brand Logo Item ==-->
                </div>
                <div class="swiper-slide">
                  <!--== Start Brand Logo Item ==-->
                  <div class="brand-logo-item">
                    <a href="shop.html"><img src="{{ asset('customer/assets/img/brand-logo/4.jpg') }}" alt="Image-HasTech"></a>
                  </div>
                  <!--== End Brand Logo Item ==-->
                </div>
                <div class="swiper-slide">
                  <!--== Start Brand Logo Item ==-->
                  <div class="brand-logo-item">
                    <a href="shop.html"><img src="{{ asset('customer/assets/img/brand-logo/5.jpg') }}" alt="Image-HasTech"></a>
                  </div>
                  <!--== End Brand Logo Item ==-->
                </div>
                <div class="swiper-slide">
                  <!--== Start Brand Logo Item ==-->
                  <div class="brand-logo-item">
                    <a href="shop.html"><img src="{{ asset('customer/assets/img/brand-logo/6.jpg') }}" alt="Image-HasTech"></a>
                  </div>
                  <!--== End Brand Logo Item ==-->
                </div>
                <div class="swiper-slide">
                  <!--== Start Brand Logo Item ==-->
                  <div class="brand-logo-item">
                    <a href="shop.html"><img src="{{ asset('customer/assets/img/brand-logo/7.jpg') }}" alt="Image-HasTech"></a>
                  </div>
                  <!--== End Brand Logo Item ==-->
                </div>
              </div>
